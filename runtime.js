...
/* Command definitions */
var commandDocValues= [["goTo","Location",["none"],["Sister.location = location."]],["open","CLocation",["CLocation.open = false", "right.free = true"],["CLocation.open = true"]],["close","CLocation",["CLocation.open = false", "right.free = true"],["CLocation.open = true"]],["open","CObject",["CObject.open = false", "right.free=true", "left.holding = Cobject"],["CObject.open = true"]],["close","CObject",["CObject.open = true", "right.free=true", "left.holding = Cobject"],["CObject.open = false"]],["get","Object",["Object.location = Sister.location.", "If Sister.location = CLocation, CLocation.open = true.", "right.free = true."],["Object is in right hand."]],["put","Object",["Right hand must hold object", "BS must be at open location."],["Object is in location.", "Right hand is free."]],["hold","Object",["Right hand must hold object.", "Left hand must be free."],["Object is in Left hand.", "Right hand is free."]],["scoop","Object",["Object must be spreadable.", "Open container is in Left hand.", "Knife is in right hand."],["Knife holds spread to coat 1 slice."]],["spread","Object",["Knife is in right hand after scooping spreadable object.", "Argument is spreadable object from scoop command", "Left hand is steadying a slice."],["Slice is coated with spreadable object.", "Knife is clean."]],["placeOver","Object",["Coated slice is in right hand.", "Target slice is on plate, coated side face up."],["Coated slice from right hand is aligned face down over coated slice face up on plate.", "Sandwich is now complete."]]];
